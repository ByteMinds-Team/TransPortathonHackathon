    ...
    where TContext : DbContext
{
                                        ...
                                        Func<IQueryable<TEntity>, IIncludableQueryable<TEntity, object>>? include = null)
    {
        ...
        // return await Context.Set<TEntity>().FirstOrDefaultAsync(queryable);
    }
    ...
    public async Task<IPaginate<TEntity>> GetListByDynamicAsync(Func<IQueryable<TEntity>,
    ...
    public IPaginate<TEntity> GetListByDynamic(Func<IQueryable<TEntity>, IIncludableQueryable<TEntity, object>>?
